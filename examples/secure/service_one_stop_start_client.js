...
const myConfig = {
  serviceName: 'LoggerXYZ', // A name to easily identify the service being monitored
  updateIntervalSeconds: 1, // Time interval, in seconds, between updates
  role: 'tlsService', // Role can either be 'service' or 'registry'
  groupingKey: 'Logger', // A grouping key so all the services of the same type are hold together
